...
has(madPrompt, 'DEEPSEEK V4.1 FLASH — KOREAN RECOMPOSITION');
has(madPrompt, 'TARGET DIALOGUE ONLY — KIM HONG-JIN');
has(madPrompt, 'SOURCE-CONTENT FIREWALL');
has(madPrompt, 'ANTI-TRANSLATION EXECUTION');
has(madPrompt, 'Short fragments may become complete spoken lines');
has(madPrompt, 'never curse at USER as a person');
has(madPrompt, 'USER-DIRECTED PROFANITY GUARD');
has(madPrompt, 'OUTPUT SHELL ONLY');
